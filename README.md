...
بوت Discord باسم **VELORA HUB** بتصميم عربي مرتب ومناسب لـ Termux: ترحيب، تذاكر دعم/شراء، إدارة بأوامر `!`، أوامر خدمات بـ `/`، حماية، نقاط، اقتراحات، ضريبة، تقييمات، وترانسكربت للتذاكر.
...
- `!leaderboard` لوحة ترتيب النقاط.
- `!afk السبب` تفعيل حالة AFK.
...
- `/ticket-close` إغلاق التذكرة مع حفظ Transcript TXT وإرسال طلب تقييم.
...
- **التذاكر:** معلومات المنشئ، وقت الفتح، رقم التذكرة، نوعها، أزرار استلام/إغلاق، Transcript عند الإغلاق، تقييم دعم 1–5.
...
- **الحماية:** Anti Spam، Anti Link، Anti Mention Spam، Anti Raid، Anti Invite، و AFK.
